...
- `main.bicepparam` documents all template parameters and safe example values, including model arrays, named RDP rules, Automation runbook descriptors, and both schedules.
