...
- Run `scripts/scan-ai-safety.ps1` to detect prompt injections, jailbreaks, hidden unicode smuggling, and harmful AI instructions in documentation and prompt files.
