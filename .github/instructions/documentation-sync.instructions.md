...
| `.github/workflows/*.yml` or `pipelines/*.yml` | `.github/README.md`, `.github/workflows/README.md`, and `pipelines/README.md` |
...
| Adding, removing, or renaming a file in a maintained folder | that folder's `README.md` and `index.md` |
